...
<script>
    ...
    $(function () {
        ...
        $("#selectPageSize").on("change",function () {
            ...
            $.ajax({
                type: "POST",
                data:{"pageSize":$(this).val(),"pageNum":"1"},
                url:"${ctx}/company/setPageSize.do",
        ...
        <div class="box box-primary">
                        ...
                        <div class="form-group form-inline">
                            <div class="btn-group">
                                <button type="button" class="btn btn-default" title="新建"
                                        onclick='location.href="${ctx}/company/toAdd.do"'><i class="fa fa-file-o"></i>
                                    新建
                                </button>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn bg-olive btn-xs"
                                            onclick='location.href="${ctx}/company/toUpdate.do?id=${item.id}"'>编辑
                                    </button>
                                </td>
                            </tr>
                        </c:forEach>
            ...
            <div class="box-footer">
                <div class="pull-left">
                    <div class="form-group form-inline">
                        ...
                        <select class="form-control" id="selectPageSize">
                            ...
                            <option ${page.pageSize == 6?"selected":""}>6</option>
                        </select> 条
                    </div>
                </div>
                ...
                <div class="box-tools pull-right">
                    <ul class="pagination">
                        <li>
                            <a href="${ctx}/company/list.do?pageNum=${page.navigateFirstPage}"
                               aria-label="Previous">首页</a>
                        </li>
                        <c:if test="${!page.isFirstPage}">
                            <li class="selected"><a href="${ctx}/company/list.do?pageNum=${page.prePage}">上一页</a></li>
                        </c:if>
                        <c:forEach items="${page.navigatepageNums}" var="pageNum">
                            <li><a href="${ctx}/company/list.do?pageNum=${pageNum}">${pageNum}</a></li>
                        </c:forEach>
                        <c:if test="${!page.isLastPage}">
                            <li><a href="${ctx}/company/list.do?pageNum=${page.nextPage}">下一页</a></li>
                        </c:if>
                        <li>
                            <a href="${ctx}/company/list.do?pageNum=${page.navigateLastPage}" aria-label="Next">尾页</a>
                        </li>
                    </ul>
                </div>
